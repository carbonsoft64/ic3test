...
import net.carbonsoft.ic.procedures.Multimeter_RCPrcdrProcedure;
...
public class MultimeterItem extends Item {
	...
	public InteractionResult useOn(UseOnContext context) {
		...
		Multimeter_RCPrcdrProcedure.execute(context.getLevel(), context.getClickedPos().getX(), context.getClickedPos().getY(),
